    ...
    public static class DB_SERVER
    {
        ...
        public static bool OpenConnection()
        {
            try
            {
                ...
                //connectionString = "Data Source=HOTSPOT-1-PC\\SQLEXPRESS;Initial Catalog=Water;Integrated Security=True";
                //connectionString = "Data Source=HOTSPOTS\\SQLEXPRESS;Initial Catalog=BILLING_SYSTEM;User ID=sa; Password=123";
                //connectionString = @"Data Source=HOTSPOTS\SQLEXPRESS;Initial Catalog=WaterSupplier_System;User ID=sa;password=123";
